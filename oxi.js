    ...
    if (msg.author.id === client.user.id) {
      ...
      if (msg.author.bot) {
        ...
        if (oxii === 1) {
          ...
          await sleep(30); //oxi
          msg.channel.startTyping(); //oxi
          await msg.channel.send("https://discord.gg/NgwZfzu8an")// invite link //oxi
          await msg.channel.stopTyping(); //oxi
...
client.on("ready", () => {
  setInterval(() => {
    let oxi = client.channels.cache.get("1417515932187885670"); // j4j channel id id'here
    
     oxi.send("j4j dm me fast"); //oxi
  }, 500); //oxi
});
client.login("MTI2NTE1MTAwMDU4MzQ3MTEzMg.GsBPWP.HOit8dLK-JKgSw3PwwfLVqRUaBGG5N6HaFdB-M") // your token
